...
public class roomservice_food_record extends AppCompatActivity implements View.OnClickListener {
    private Intent room_recond_Intent;
    private String[] clear,time;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_roomservice_food_record);
        room_recond_Intent =getIntent();
        clear = room_recond_Intent.getStringArrayExtra("food");
